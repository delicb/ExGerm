...
public class DFSCommand implements ExGCommand {

	ICoreContext context;

	public DFSCommand(ICoreContext context) {
		super();
	...
	public Object execute(PrintStream out, String... params)
		...
		try {
			result = search.search(ExGIterator.DEPTH_FIRST);
	...
	public String getSyntax() {
		return "Use dfs <start_node> <finish_node>";
	}

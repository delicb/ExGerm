...
public class EdgeStateAction extends ExGAction {

	private ViewManager viewManager;
	
	public EdgeStateAction(ViewManager _vm){
		putValue(NAME, "Edge State"); //$NON-NLS-1$
		putValue(SMALL_ICON, loadIcon("images/connect.png"));
		putValue(SHORT_DESCRIPTION, "Add new edge"); //$NON-NLS-1$
		viewManager = _vm;
	}
	...
	public void actionPerformed(ActionEvent arg0) {
		try{
			viewManager.getActiveView().getStateManager().setNextState(StateManager.States.EDGE, null);
		}catch(Exception e){
